...
public class BlastSelectionGUI {

    private Main plugin;

    public BlastSelectionGUI(Main plugin) {
        this.plugin = plugin;
    }

    public Inventory openInventory() {

        String guiName = plugin.getMessages().getString("blast-tool.selectiongui.gui_name");
        ...
        String trenchName = plugin.getMessages().getString("blast-tool.selectiongui.trench.name");
        trenchMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', trenchName));
        List<String> trenchLore = new ArrayList<>();
        Iterator trenchLoreIterator = plugin.getMessages().getStringList("blast-tool.selectiongui.trench.lore").iterator();
        ...
        String trayName = plugin.getMessages().getString("blast-tool.selectiongui.tray.name");
        trayMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', trayName));
        List<String> trayLore = new ArrayList<>();
        Iterator trayLoreIterator = plugin.getMessages().getStringList("blast-tool.selectiongui.tray.lore").iterator();
        ...
        ItemStack mainBackground = Extras.getColor(BlastConfig.getMainSelectionColor());
        ItemStack secondaryBackground = Extras.getColor(BlastConfig.getSecondarySelectionColor());
        ItemStack complimentBackground = Extras.getColor(BlastConfig.getComplimentSelectionColor());
